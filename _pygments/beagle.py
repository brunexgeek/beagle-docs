...
class BeagleLexer(RegexLexer):
    """
    For `Beagle <https://github.com/brunexgeek/beagle-compiler>`_ source code.
    """

    name = 'Beagle'
    aliases = ['beagle']
    filenames = ['*.beagle', '*.bgl']
    mimetypes = ['text/x-beagle']
    ...
    tokens = {
        'root': [
            # method names
            (r'(class|contract|object)(\s+)', bygroups(Keyword, Text), 'class'),
